...
public class Welcome {
  public static String greet(String language){
    HashMap<String, String> countriesWithGreetings = new HashMap<>() {{
       put("english", "Welcome");
       put("czech", "Vitejte");
       put("danish", "Velkomst");
       put("dutch", "Welkom");
       ...
       put("welsh", "Croeso");
       put("IP_ADDRESS_INVALID", "Welcome");
       put("IP_ADDRESS_NOT_FOUND", "Welcome");
       put("IP_ADDRESS_REQUIRED", "Welcome");
    }};
     
    return countriesWithGreetings.get(language);
  }
}