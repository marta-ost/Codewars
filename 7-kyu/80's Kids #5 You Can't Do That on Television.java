...
public class EightiesKids5 {
  public static String bucketOf(String said) {
    String[] waterWords = {"water", "wet", "wash"};
    String[] slimeWords = {"slime", "i don't know"};
    
    boolean water = checkTextForWords(said, waterWords);
    boolean slime = checkTextForWords(said, slimeWords);
  ...
  private static boolean checkTextForWords(String text, String[] words) {
